...
is_raining = False
print("우산을 챙기세요" if is_raining == True else "우산 불필요")
...
#   name = ""          → "이름 없음"
name = ""
print("이름 없음" if name is "" else name)
...
#   items = []              → "목록이 비었습니다"
items = []
print(items[0] if items else "목록이 비었습니다")
