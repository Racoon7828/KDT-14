...
## --------------------------------------------
# 내장 함수와 사용법 : map(), filter()
## --------------------------------------------
## 6. map(함수이름 또는 코드, 반복이 가능한타입)
#  - 모든 원소에 함수/코드 적용
#  - 반환값 : map타입 ===> 원하는 타입으로 형변환 필요
## --------------------
nums = [1, 2, 3, 4]
...
result = [x for x in nums if not x % 2]
print(result)   # [2, 4, 6]
...
## 9. 딕셔너리 값 기준 정렬
## ----------------------
data = {"a": 3, "b": 1, "c": 2, "d": 6, "e": 5}

# [기준] 키 기준 정렬
result = sorted(data.items())
print(result)   # [('a', 3), ('b', 1), ('c', 2)]
